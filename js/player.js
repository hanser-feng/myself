...
class Musics {
    ...
    constructor() {
        this.songs = [{
                id: 1,
                title: '蚂蚁筑起高塔 (Live) ',
                singer: '汪苏泷 - 蚂蚁筑起高塔 (Live) ',
                songUrl: './songs/汪苏泷 - 蚂蚁筑起高塔 (Live) .mp3',
                imageUrl: './images/songs/歌手.jpg'
            },
            {
                id: 2,
                title: '若月亮没来 (Live)',
                singer: '杨宗纬 _ 宝石Gem _ 王宇宙Leto - 若月亮没来 (Live)',
                songUrl: './songs/杨宗纬 _ 宝石Gem _ 王宇宙Leto - 若月亮没来 (Live).mp3',
                imageUrl: './images/songs/天赐的声音.jpg'
            },
			{
                id: 3,
